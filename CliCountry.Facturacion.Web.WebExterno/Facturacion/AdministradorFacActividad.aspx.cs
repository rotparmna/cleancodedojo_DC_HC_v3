...
namespace CliCountry.Facturacion.Web.WebExterno.Facturacion
{
    ...
    public partial class AdministradorFacActividad : WebPage
    {
        ...
        /// <summary>
        /// Obtiene o establece la atencion.
        /// </summary>
        ...
        {
            ControlConceptos ctrl = new ControlConceptos();
            var resultadoConceptos = ctrl.ConsultarConceptos(
            new Atencion()
            {
                IdAtencion = Atencion.IdAtencion
            });
        ...
        /// <summary>
        /// Generar el estado de cuenta la factura.
        /// </summary>
        /// <remarks>
        /// Autor: Iván José Pimienta Serrano - INTERGRUPO\Ipimienta
        ...
        private void GenerarEstadoCuenta()
        {
            if (Page.IsValid)
            {
                ...
                VinculacionSeleccionada = BuscarVinculacion(Convert.ToInt32(identificadorEntidad.Text), indiceFila + 1);
                grvEntidades.SelectedIndex = 0;
                this.ActivarCeldaGridView(grvEntidades, indiceFila);
                this.ValidarVentasSeleccionadas();
            }
            else
            {
                this.MostrarMensaje(null, TipoMensaje.Error);
            }
        }

        /// <summary>
        /// Valida si hay  Ventas Seleccionadas para relizar el proceso factura 
        /// </summary>
        private void ValidarVentasSeleccionadas()
        {
            ...
            {
                this.CrearProcesoFactura(ventasSeleccionadas);
                this.ConsultarConceptosAtencion();
            ...
            {
                this.MostrarMensaje(Resources.GlobalWeb.General_DebeSeleccionarVentas, TipoMensaje.Error);
            }
        }

        /// <summary>
        /// Consulta los conceptos de la atencion seleccionaday se guarda en sesion
        /// </summary>
        private void ConsultarConceptosAtencion()
        {
            ControlConceptos CtrlConceptos = new ControlConceptos();
            var resultadoConceptos = CtrlConceptos.ConsultarConceptos(
            new Atencion()
            {
                IdAtencion = Atencion.IdAtencion
            });
        ...
        /// <summary>
        ///  Crea el proceso factura de la generacion del estado de cuenta. y se guarda en sesion
        /// </summary>
        /// <param name="ventasSeleccionadas">lista de ids de la ventas seleccionadas</param>
        public void CrearProcesoFactura(List<int> ventasSeleccionadas)
        {
        ...
        /// <summary>
        /// Retorna la lista de vinculaciones seleccionadas, y sus respcetivas observaciones
        /// </summary>
        /// <returns>Retorna lista de vinculaciones.</returns>
        /// <remarks>
